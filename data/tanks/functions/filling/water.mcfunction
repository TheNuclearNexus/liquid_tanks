...
execute if score @s ES_ID matches 1 unless score @s ES_stored matches 19.. if entity @e[distance=..1,type=item,nbt={Item:{id:"minecraft:water_bucket",Count:1b}},tag=!filled] run scoreboard players add @s ES_stored 3
