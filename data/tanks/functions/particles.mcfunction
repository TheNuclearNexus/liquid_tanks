...
execute at @s if entity @s[scores={ES_ID=7..8}] run particle block brown_mushroom_block ~ ~1.1 ~ 0 0 0 0.1 3 normal @a[distance=..5]
execute at @s if entity @s[scores={ES_ID=9}] run particle block nether_wart_block ~ ~1.1 ~ 0 0 0 0.1 3 normal @a[distance=..5]
